...
def test_model(test_dir="data/testImages", has_masks=False):
    ...
    print("Testing UNet (ResNet50) model")
    print("="*60)
    ...
    if has_masks:
        ...
        print(f"\nTest Results for UNet (ResNet50):")
        ...
        plt.title('Test Confusion Matrix - UNet (ResNet50)')
        plt.xlabel('Predicted')
        plt.ylabel('True')
        plt.tight_layout()
        plt.savefig('test_confusion_matrix_unet.png', dpi=300)
        plt.close()
        
        print(f"\nConfusion matrix saved to test_confusion_matrix_unet.png")
        ...
        with open('test_report_unet.txt', 'w') as f:
            f.write("Test Report - UNet (ResNet50)\n")
            f.write("="*50 + "\n\n")
        ...
        print(f"Detailed report saved to test_report_unet.txt")
        ...
        for img_path in tqdm(test_images, desc="Processing test images"):
            try:
                ...
                plt.suptitle(f"UNet (ResNet50) - {os.path.basename(img_path)}", fontsize=14)
                plt.tight_layout()
