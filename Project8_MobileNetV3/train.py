...
def main():
    ...
    model = MobileNetV3Segmentation(num_classes=11, variant='large', pretrained=True).to(device)
    ...
    final_model = MobileNetV3Segmentation(num_classes=11, variant='large', pretrained=False).to(device)
    checkpoint = torch.load('best_model.pth', map_location=device)
    final_model.load_state_dict(checkpoint['model_state_dict'])
    torch.save(final_model.state_dict(), 'mobilenetv3_final.pth')
    print("Final model saved as mobilenetv3_final.pth")
