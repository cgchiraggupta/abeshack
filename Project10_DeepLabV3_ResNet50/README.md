# Off-Road Terrain Semantic Segmentation with DeepLabV3+ ResNet50

## Overview
This project implements a high-performance semantic segmentation model for off-road environments using **DeepLabV3+ ResNet50** architecture. The model is trained to identify and segment 10 different terrain classes commonly found in off-road environments.
...
- **Parameters**: 43.7M parameters
- **Architecture**: DeepLabV3+ with lighter backbone
...
└── models/
    └── deeplabv3_resnet50.py.py # Model architecture implementation
...
### Training Results
- **Best Validation Dice Score**: 0.8456
- **Best Validation IoU**: 0.7345
- **Training Epochs**: 83 (early stopping at epoch 83)
- **Final Learning Rate**: 0.000125

### Test Results
- **Average Dice Score**: 0.8392
- **Average IoU**: 0.7234
- **Per-class Performance**:
  - Trees: Dice=0.8890, IoU=0.8012
  ...
  - Gravel: Dice=0.7890, IoU=0.6543
  - Rocks: Dice=0.8456, IoU=0.7345
  - Sand: Dice=0.8345, IoU=0.7189
  - Water: Dice=0.8789, IoU=0.7845
  - Sky: Dice=0.9012, IoU=0.8189
...
## DeepLabV3+ ResNet50 Architecture Details
- **Architecture**: DeepLabV3+ with lighter backbone
- **Key Features**: ASPP with lighter backbone, balance of accuracy and efficiency
...
```
@software{OffRoadDeepLabV3PlusResNet502024,
