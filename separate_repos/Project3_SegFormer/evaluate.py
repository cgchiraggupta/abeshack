...
def evaluate_model():
    ...
    print(f"Evaluating SegFormer-B2 on {len(val_imgs)} validation images")
    ...
    print(f"\n{'='*50}")
    print(f"Evaluation Results for SegFormer-B2")
    print(f"{'='*50}")
    ...
    plt.title('Confusion Matrix - SegFormer-B2')
    plt.xlabel('Predicted')
    plt.ylabel('True')
    plt.tight_layout()
    plt.savefig('confusion_matrix_segformer.png', dpi=300)
    plt.close()
    
    print(f"\nConfusion matrix saved to confusion_matrix_segformer.png")
