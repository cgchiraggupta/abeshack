...
def main():
    ...
    model = EfficientNetSegmentation(num_classes=11, variant='b4', pretrained=True).to(device)
    ...
    final_model = EfficientNetSegmentation(num_classes=11, variant='b4', pretrained=False).to(device)
    checkpoint = torch.load('best_model.pth', map_location=device)
    final_model.load_state_dict(checkpoint['model_state_dict'])
    torch.save(final_model.state_dict(), 'efficientnetb4_final.pth')
    print("Final model saved as efficientnetb4_final.pth")
