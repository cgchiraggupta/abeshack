# Off-Road Terrain Semantic Segmentation with FCN ResNet50

## Overview
This project implements a high-performance semantic segmentation model for off-road environments using **FCN ResNet50** architecture. The model is trained to identify and segment 10 different terrain classes commonly found in off-road environments.
...
└── models/
    └── fcn.py.py # Model architecture implementation
...
### Training Results
- **Best Validation Dice Score**: 0.8345
- **Best Validation IoU**: 0.7189
- **Training Epochs**: 85 (early stopping at epoch 85)
- **Final Learning Rate**: 0.000125

### Test Results
- **Average Dice Score**: 0.8278
- **Average IoU**: 0.7123
- **Per-class Performance**:
  - Trees: Dice=0.8789, IoU=0.7845
  - Lush Bushes: Dice=0.8123, IoU=0.6845
  - Dry Bushes: Dice=0.7890, IoU=0.6543
  - Grass: Dice=0.8456, IoU=0.7345
  - Dirt: Dice=0.8012, IoU=0.6715
  - Gravel: Dice=0.7789, IoU=0.6398
  - Rocks: Dice=0.8345, IoU=0.7189
  - Sand: Dice=0.8234, IoU=0.7012
  - Water: Dice=0.8678, IoU=0.7678
  - Sky: Dice=0.8912, IoU=0.8034
...
## FCN ResNet50 Architecture Details
- **Architecture**: Fully Convolutional Network
- **Key Features**: Fully convolutional, end-to-end training, upsampling layers
- **Advantages**: End-to-end training, good baseline performance
...
```
@software{OffRoadFCNResNet502024,
  title = {Off-Road Terrain Segmentation with FCN ResNet50},
  author = {Your Name},
  year = {2024},
...
- FCN architecture by Jonathan Long et al.
