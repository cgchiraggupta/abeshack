...
class MobileNetV3Inference:
    def __init__(self, model_path, device='cuda'):
        ...
        self.model = MobileNetV3Segmentation(num_classes=11, variant='large', pretrained=False).to(self.device)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='MobileNetV3 Inference for Off-Road Terrain Segmentation')
    parser.add_argument('--model', type=str, default='mobilenetv3_final.pth',
    ...
    inference = MobileNetV3Inference(args.model)
